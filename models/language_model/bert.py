...
class Roberta(nn.Module):
    def __init__(self, name, outdim, freeze=False) -> None:
        ...
        self.body = RobertaModel.from_pretrained("/workspace/CGSTVG/model_zoo/roberta-base/")
        self.tokenizer = RobertaTokenizerFast.from_pretrained(pretrained_model_name_or_path='/workspace/CGSTVG/model_zoo/roberta-base/')
