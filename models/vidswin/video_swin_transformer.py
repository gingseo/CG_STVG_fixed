...
class WindowAttention3D(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        coords = torch.stack(torch.meshgrid(coords_d, coords_h, coords_w, indexing="ij"))  # 3, Wd, Wh, Ww # 만약 오류나면 indexing지움
...
model_paths = {
    "video_swin_t_p4w7_k400_1k": "/workspace/CGSTVG/model_zoo/swin_tiny_patch244_window877_kinetics400_1k.pth",
